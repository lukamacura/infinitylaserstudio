...
const members = [
  {
    ...
    bio: "Preciznost, toplina i posvećenost — Mila svaku klijentkinju dočeka s pažnjom kakvu zaslužuje. Specijalizovana za tretmane lica i osetljivih zona.",
    src: "/mila.jpg",
    accent: "#ACE6E4",
  },
  {
    ...
    bio: "Mirna ruka, brz tretman i uvek raspoložena za razgovor. Tanja se stara da se iz ordinacije izađe s osmehom — i bez dlaka.",
    src: "/tanja.jpg",
    accent: "#FCCAE2",
  },
];

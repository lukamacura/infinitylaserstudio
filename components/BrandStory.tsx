      ...
      >
        ...
        <div>
          ...
          <p className="font-poppins text-gray-600 text-base leading-relaxed mb-4">
            Brijanje traje 5 minuta. A posledice — crvenilo, dlake pod kožom, ubodi — traju danima.
          </p>
          <p className="font-poppins text-gray-600 text-base leading-relaxed mb-4">
            Laserska epilacija nije samo estetski tretman. To je odluka da prestaneš da trošiš vreme na nešto što te frustrira.
          </p>
          <p className="font-poppins text-gray-500 text-sm leading-relaxed">
            Jedna serija tretmana. I ta jutarnja rutina zauvek postaje kraća.
          </p>

          {/* Mini stats */}
          <div className="flex gap-8 mt-8">
            {[
              { value: "2 000+", label: "Zadovoljnih klijenata" },
              { value: "5+", label: "Godina iskustva" },
              { value: "99%", label: "Stopa zadovoljstva" },
            ].map((stat) => (
              <div key={stat.label}>
        ...
        <div className="relative flex justify-center">
          <img
            src="/img1.png"
            alt="Infinity Laser Studio tretman"
            className="relative z-10 w-full max-w-sm rounded-3xl shadow-lg"
          />
